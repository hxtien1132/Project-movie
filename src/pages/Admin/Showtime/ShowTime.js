...
import { taoLichChieu } from '../../../services/tickets';
import { layThongTinCumRap, layThongTinHeThongRap } from '../../../services/cimena';
...
export default function ShowTime(props) {
    ...
    return (
        ...
        <div className="container">
            ...
            >
                <h3 className="text-2xl">Tạo lịch chiếu - {params.tenphim}</h3>
