...
import { SET_CHI_TIET_PHIM } from '../../redux/types/QuanLiRapTypes';
...
export default function Detail() {  
    ...
    const filmDetail = useSelector(state => state.QuanLiPhimReducer.filmDetail);
    ...
    useEffect(() => {
        dispatch(layThongTinChiTietPhimAction(params.id))
    }, [])
    return (
                ...
                <div className="grid grid-cols-12 mt-5">
                    <div className="col-span-4 col-start-4">
                        <div className="grid grid-cols-3">
                            ...
                            <div className="col-span-2 ml-3 " style={{ color: '#fff' }}>
                                <p style={{ color: 'yellow' }} className="text-sm">Ngày chiếu: {moment(filmDetail.ngayKhoiChieu).format('DD.MM.YYYY')}</p>
                    ...
                    <div className="col-span-4">
                        <h1 style={{ marginLeft: '35%', color: 'yellow', fontWeight: 'bold', fontSize: 15 }}>Đánh giá</h1>
                        <h1 style={{ marginLeft: '25%' }} className="text-green-400 text-2xl"><Rate allowHalf value={filmDetail.danhGia / 2} style={{ color: '#78ed78', fontSize: 30 }} /></h1>
                        <div style={{ marginLeft: '20%' }} className={`c100 p${filmDetail.danhGia * 10} big`}>
